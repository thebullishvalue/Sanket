...
def _render_signal_legend(side: str = 'long') -> None:
    ...
    ">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 0.45rem 1.5rem;">
            <div>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.75rem; font-weight:600; color:#F1F5F9;">Signal</span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#4B5563;"> · </span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#94A3B8;">{signal_desc}</span>
            </div>
            <div>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.75rem; font-weight:600; color:#F1F5F9;">Trend</span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#4B5563;"> · </span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#94A3B8;">{trend_desc}</span>
            </div>
            <div>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.75rem; font-weight:600; color:#F1F5F9;">Timing</span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#4B5563;"> · </span>
                <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#94A3B8;">{timing_desc}</span>
            </div>
        </div>
        <div style="margin-top: 0.6rem; padding-top: 0.6rem; border-top: 1px solid rgba(255,255,255,0.05);">
            <span style="font-family:'IBM Plex Mono',monospace; font-size:0.75rem; font-weight:600; color:#F1F5F9;">Reading Signal &amp; Trend together</span>
            <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#4B5563;"> · </span>
            <span style="font-family:'IBM Plex Mono',monospace; font-size:0.72rem; color:#94A3B8;">{together_good} &nbsp;&nbsp;{together_mixed}</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
